                ...
                <div class="booksmedia-detail-main">
                    <div class="container">
                        ...
                        <div class="booksmedia-detail-box">
                            ...
                            <div class="clearfix"></div>
                            <p><strong>Summary:</strong> There are many variations of passages of Lorem Ipsum available,
                            ...
                            <div class="table-tabs" id="responsiveTabs">
                                <ul class="nav nav-tabs">
                                    <li class="active"><b class="arrow-up"></b><a data-toggle="tab" href="#sectionA">Available Books</a></li>
                                    <li><b class="arrow-up"></b><a data-toggle="tab" href="#sectionB">Add a Book</a>
                                    </li>
                                ...
                                <div class="tab-content">
                                    ...
                                    <div id="sectionB" class="tab-pane fade in">
                                        <h3 align="center">Add a book to your collection</h3><br><br>
                                        <?php
                                        $bookid = 0;
                                        $authorid = 0;
                                        $title = "";
                                        ...
                                        <h6 class=" formh3">Author ID: </h6><input type=" text" name="authorid" /><br>
                                            <h6 class="formh3">Title: </h6><input type=" text" name="title" id="" /><br>
                                            <h6 class="formh3">ISBN: </h6><input type="text" name="ISBN" /><br>
                                            <h6 class="formh3">Public Year: </h6><input type="text" name="pub_year" /><br>
                                            <h6 class="formh3">Available: </h6><input type="text" name="available" id="" /><br>
                                        ...
                                        if ($title != '' && $ISBN != '') {
                                            $insert = "INSERT INTO `books` (`authorid`, `title`, `ISBN`, `pub_year`, `available`) VALUES ('" . $authorid . "','" . $title . "','" . $ISBN . "', '" . $pub_year . "', '" . $available . "')";
                                            echo $insert;
                                            $myDB->query($insert);
